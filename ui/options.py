...
OPTIONS = OrderedDict([
  ...
  ("progression_eye_reef_chests", "This controls whether the chests that appear after clearing out the eye reefs can contain progress items.\nIf this is not checked, they will only contain optional items you don't need to beat the game."),
  ("progression_big_octos_gunboats", "This controls whether the items dropped by Big Octos and Gunboats can contain progress items.\nIf this is not checked, they will only contain optional items you don't need to beat the game."),
  ...
  ("progression_expensive_purchases", "This controls whether the items sold in the Rock Spire Shop Ship and the Auction House can be progress items.\nIf this is not checked, they will only sell optional items you don't need to beat the game."),
  ("progression_gifts", "This controls whether gifts freely given by NPCs can be progress items.\nIf this is not checked, they will only be optional items you don't need to beat the game."),
