...
OPTIONS = OrderedDict([
  ...
  ("progression_minigames", "This controls whether minigames can reward progress items.<br><u>If this is not checked, minigames will still be randomized</u>, but will only reward optional items you don't need to beat the game."),
  ...
  ("progression_expensive_purchases", "This controls whether items that must be bought for a large number of rupees (100+) can be progress items.<br><u>If this is not checked, they will still be randomized</u>, but will only be optional items you don't need to beat the game."),
  ("progression_gifts", "This controls whether gifts freely given by NPCs can be progress items.<br><u>If this is not checked, they will still be randomized</u>, but will only be optional items you don't need to beat the game."),
  ...
  ("progression_misc", "Miscellaneous locations that don't fit into any of the above categories.<br><u>If this is not checked, they will still be randomized</u>, but will only contain optional items you don't need to beat the game."),
