...
OPTIONS = OrderedDict([
  ...
  ("progression_expensive_purchases", "This controls whether items that must be bought for a lot of rupees can be progress items (Rock Spire shop, auctions, Tingle's letter).<br><u>If this is not checked, they will still be randomized</u>, but will only be optional items you don't need to beat the game."),
