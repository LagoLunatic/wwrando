...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_for_player_shirt_color = QtGui.QLabel(self.tab_2)
        self.label_for_player_shirt_color.setObjectName("label_for_player_shirt_color")
        self.horizontalLayout_5.addWidget(self.label_for_player_shirt_color)
        self.player_shirt_color = QtGui.QPushButton(self.tab_2)
        self.player_shirt_color.setText("")
        self.player_shirt_color.setObjectName("player_shirt_color")
        self.horizontalLayout_5.addWidget(self.player_shirt_color)
        self.gridLayout_5.addLayout(self.horizontalLayout_5, 1, 0, 1, 1)
        self.horizontalLayout_6 = QtGui.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.label_for_player_pants_color = QtGui.QLabel(self.tab_2)
        self.label_for_player_pants_color.setObjectName("label_for_player_pants_color")
        self.horizontalLayout_6.addWidget(self.label_for_player_pants_color)
        self.player_pants_color = QtGui.QPushButton(self.tab_2)
        self.player_pants_color.setText("")
        self.player_pants_color.setObjectName("player_pants_color")
        self.horizontalLayout_6.addWidget(self.player_pants_color)
        self.gridLayout_5.addLayout(self.horizontalLayout_6, 1, 1, 1, 1)
        self.horizontalLayout_12 = QtGui.QHBoxLayout()
        self.horizontalLayout_12.setObjectName("horizontalLayout_12")
        self.label_for_player_hair_color = QtGui.QLabel(self.tab_2)
        self.label_for_player_hair_color.setObjectName("label_for_player_hair_color")
        self.horizontalLayout_12.addWidget(self.label_for_player_hair_color)
        self.player_hair_color = QtGui.QPushButton(self.tab_2)
        self.player_hair_color.setText("")
        self.player_hair_color.setObjectName("player_hair_color")
        self.horizontalLayout_12.addWidget(self.player_hair_color)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_for_player_hair_color.setText(QtGui.QApplication.translate("MainWindow", "Player Hair Color", None, QtGui.QApplication.UnicodeUTF8))
